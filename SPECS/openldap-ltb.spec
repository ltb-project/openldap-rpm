...
install -m 644 \
  ...
  %{slapd_cli_name}-%{slapd_cli_version}/config-template-2.5.conf \
  %{slapd_cli_name}-%{slapd_cli_version}/config-template-2.5.ldif \
  %{slapd_cli_name}-%{slapd_cli_version}/data-template-2.5.ldif \
...
%{ldapserverdir}/libexec/openldap/ppm.so
%{ldapserverdir}/libexec/openldap/ppm_test
%dir %{ldapdir}/%{_lib}/
%{ldapdir}/%{_lib}/liblber.la
%{ldapdir}/%{_lib}/liblber-2.5.so.0*
%{ldapdir}/%{_lib}/libldap.la
%{ldapdir}/%{_lib}/libldap-2.5.so.0*
...
%exclude %{ldapserverdir}/share/man/man5/slapd-ndb.5
...
#=================================================
%changelog
* Thu May 22 2025 - David Coutadeur <david.coutadeur@gmail.com> - 2.5.20-1
- Upgrade to OpenLDAP 2.5.20
...
* Wed Aug 23 2023 - Clement Oudot <clem@ltb-project.org> - 2.5.16-1
- Upgrade to OpenLDAP 2.5.16
